...
#             raise TimeoutError("Quá thời gian tìm kiếm (2 phút)")

#         # Đăng ký handler cho timeout
#         signal.signal(signal.SIGALRM, timeout_handler)
#         signal.alarm(200)  # 2 phút = 120 giây
...
#         print(f"\nLỗi: {str(e)}")
#         print("Không tìm thấy thông tin phù hợp trong thời gian cho phép (2 phút)")
#         return []
#     except Exception as e:
#         print(f"\nLỗi không xác định: {str(e)}")
#         return []
#     finally:
#         # Đảm bảo luôn hủy timeout
#         signal.alarm(0)
